...
param_grid = {
    ...
    'learning_rate': [0.1, .05],  # Learning rate
    'subsample': [0.9],  # Subsample ratio of the training instances
    'colsample_bytree': [0.9],  # Subsample ratio of columns when constructing each tree
    'gamma': [0.1, .05],  # Minimum loss reduction required to make a further partition
    'min_child_weight': [8, 10, 12]  # Minimum sum of instance weight (hessian) in a child
}
